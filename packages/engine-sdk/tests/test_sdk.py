...
""".strip(),
    ...
    def test_semantic_fingerprint_ignores_volatile_metering_values(self) -> None:
        ...
        self.assertTrue(is_volatile_metering_signal("meter_water.daily"))
        self.assertTrue(is_volatile_metering_signal("water", 0.017))
        self.assertFalse(is_volatile_metering_signal("water", True))
